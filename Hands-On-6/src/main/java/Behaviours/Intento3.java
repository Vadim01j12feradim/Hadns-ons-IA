...
public class Intento3 extends SimpleBehaviour{
    ...
    public Intento3(Agent a, double[] xt,double[] yt){
        ...
        double num_steps = 50;//Numero de iteraciones
    ...
    public void iteration(){
        ...
        for (int i = 0; i < trX.length; i++) {
            b_0_gradient += (double)((double)1/(double)N)*(double)(trY[i]-((double)b_0 + (double)(double)b_1 * (double)trX[i]));
            b_1_gradient += (double)((double)1/(double)N)*(double)trX[i]*((double)trY[i]-(double)((double)b_0 + (double)b_1 * (double)trX[i]));
        }
        b_0 = (double)b_0 - (double)((double)learningRate * (double)b_0_gradient);
        b_1 = (double)b_1 - (double)((double)learningRate * (double)b_1_gradient);
        ...
        public boolean done(){
            if (Math.max(Math.abs(learningRate * b_0_gradient),Math.abs(learningRate * b_1_gradient))<criteria ||
                    step == num_steps) {
