 ...
 * @author sensei
 */
public class Final extends SimpleBehaviour{
    double[] trX;
    double[] trY;


    public Final(Agent a, double[] xt,double[] yt){
        myAgent  = a;
        ...
        double num_steps = 500000;//1900000;//Numero de iteraciones

        double[] yPredict = new double[(int)num_steps];
        double learningRate =  0.000008;//0.000005
        double criterial = 4;//5.476362;//Error minimo
