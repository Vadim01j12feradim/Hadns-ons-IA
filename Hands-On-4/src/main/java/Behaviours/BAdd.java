...
public class BAdd extends SimpleBehaviour{
    ...
    Dataset data;
    float TV,Radio,Newspape,Sales,x21,x22,x23,y2,x1x3,x2x3,x1y,x2y,x3y;
    Expresion actually;
    int i=0;
    public BAdd(Agent a, Dataset dt){
        myAgent  = a;
        data = dt;
    ...
    private void sumatorie(){
            ...
            y2 += (actually.getSales()*actually.getSales());
    ...
    private void sendMessage() throws IOException{
        System.out.println("\n\nΣn="+i+"\tΣTV="+TV+"\tΣRadio="+Radio+"\tΣNewspape="+Newspape+"\tΣSales="+Sales+"\tΣx²1="+x21+"\tΣx²2="+x22+
                "\tΣx²3="+x23+"\tΣx1x2="+y2+"\tΣx1x3="+x1x3+"\tΣx2x3="+x2x3+"\tΣx1y="+x1y+"\tΣx2y="+x2y+"\tΣx3y="+x3y);
        
        System.out.println("\n\n\t\t\t\tMatriz");
        System.out.println("\t| a  | "+i+"    "+TV+"    "+Radio+"    "+Newspape+"    | |  "+Sales+"   |");
        System.out.println("\t| b1 | "+TV+"  "+x21+"   "+y2+"  "+x1x3+"  | |  "+x1y+" |");
        System.out.println("\t| b2 | "+Radio+"  "+y2+"  "+x22+"   "+x2x3+"  | |  "+x2y+" |");
